...
# df = pd.read_csv('tmp/clicks_train_50_50.csv', nrows = 10)
# print df
...
def prepare_batch(batch):
    ...
    # print "haha",batch.display_id - 1, "haha"
    # print df_display.iloc[batch.display_id - 1]
...
df = pd.read_csv('tmp/clicks_train_50_50.csv')
# print df[0]
